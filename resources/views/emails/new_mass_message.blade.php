    ...
    <div id="app" class="container">
		<div style="position:relative; height:100%;">
			...
			<div style="font-family: 'Playfair Display', serif;">
				<p style="padding: 0px 35px 15px;">{{ $body }}<br/><br/> I can be reached by phone at <span style="color: blue;"><i>{{ $setting->phone }}</i></span> or by email at <a href="mailto:{{ $setting->email }}" class=""><i>{{ $setting->email }}</i>.</a></p>
