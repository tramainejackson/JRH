...
<body class="respond" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
	...
	<table style="display:none!important;">
		<tbody>
			<tr>
				<td>
					<div style="overflow:hidden;display:none;font-size:1px;color:#ffffff;line-height:1px;font-family:Arial;maxheight:0px;max-width:0px;opacity:0;">Pre-header for the newsletter template</div>
				</td>
			</tr>
		</tbody>
	</table>
					...
					<tbody>
						<tr>
							<td align="center" class="section-img">
								<a href="" style=" border-style: none !important; display: block; border: 0 !important;"><img src="/images/jr.jpg" style="display: block; width: 590px;" width="590" border="0" alt=""></a>
							</td>
						</tr>
						...
						<tr>
							<td align="center" style="color: #343434; font-size: 24px; font-family: Quicksand, Calibri, sans-serif; font-weight:700;letter-spacing: 3px; line-height: 35px;" class="main-header">
								...
								<div style="line-height: 35px">
									<p>
										PROPERTY<span style="color: #5caad2;">SHOWINGS</span>
									</p>
										...
										<tr>
											<td align="center" style="color: #888888; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
												<div style="line-height: 24px">
													<p>Good day beautiful people! Please take a look at our upcoming showings. Hope to see you soon.</p>
												</div>
											</td>
										</tr>
									</tbody>
								...
								<tr>
									<td>
										<table border="0" align="left" cellpadding="0" cellspacing="0" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="container590">
											...
											<tbody><tr>
												<td align="center">
													<a href="" style=" border-style: none !important; border: 0 !important;"><img src="{{ asset(str_ireplace('public', 'storage', $showing->property->medias()->default()->first()->path)) }}" style="display: block; width: 280px;" width="280" border="0" alt=""></a>
												</td>
											</tr>
											</tbody>
										</table>
											...
											<tbody>
												<tr>
													<td align="left" style="color: #3d3d3d; font-size: 22px; font-family: Quicksand, Calibri, sans-serif; font-weight:700;letter-spacing: 3px; line-height: 35px;" class="align-center main-header">
														...
														<div style="line-height: 35px">
															...
															<h4>
																{{ $showing->show_time->format('h:i A') }}

																<br/>

																{{ $showing->show_date->format('l F jS\\, Y') }}
												...
												<tr>
													<td align="left" style="color: #888888; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;" class="align-center">
														...
														<div style="line-height: 24px">
															<p style="margin: 15px 10px;">{{ $showing->show_instructions }}</p>
																			...
																			<tr>
																				<td align="center" style="color: #5caad2; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 20px;">
																					...
																					<div style="line-height: 20px;">
																						<a href="{{ route('properties.show', ['id' => $showing->property->id]) }}" style="color: #5caad2; text-decoration: none;">View Details</a>
																					</div>
																				</td>
																			</tr>
									...
									<tr>
										<td align="left" style="color: #888888; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 23px;" class="text_color">
											<div style="color: #333333; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; font-weight: 600; mso-line-height-rule: exactly; line-height: 23px;">
												...
												Email us: <br> <a href="mailto:lorenzo@jacksonrentalhomesllc.com" style="color: #888888; font-size: 14px; font-family: 'Hind Siliguri', Calibri, Sans-serif; font-weight: 400;">lorenzo@jacksonrentalhomesllc.com</a>
