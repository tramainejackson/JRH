...
{{--					</div>--}}
{{--				</li>--}}
				<li class="nav-item"><a href="https://app.tenantturner.com/listings/jacksonrentalhomes" target="_blank" class="nav-link{{ substr_count(url()->current(),'listings') > 0 ? ' activeNav': '' }}">Properties</a></li>
				<li class="nav-item"><a href="https://lorenzodevonj.clickfunnels.com/optin1642391845538" target="_blank" class="nav-link{{ substr_count(url()->current(),'clickfunnels') > 0 ? ' activeNav': '' }}">Property Management</a></li>
...
{{--				<li class="nav-item"><a href="/blogs" class="nav-link{{ substr_count(url()->current(),'blog') > 0 ? ' activeNav': '' }}">Blogs</a></li>--}}
				<li class="nav-item"><a href="https://app.tenantturner.com/listings/jacksonrentalhomes" target="_blank" class="nav-link{{ substr_count(url()->current(),'propert') > 0 ? ' activeNav': '' }}">Properties</a></li>
				<li class="nav-item"><a href="https://lorenzodevonj.clickfunnels.com/optin1642391845538" target="_blank" class="nav-link{{ substr_count(url()->current(),'propert') > 0 ? ' activeNav': '' }}">Property Management</a></li>
