...
{{--						</li>--}}
						<li class="">
							<a href="https://app.tenantturner.com/listings/jacksonrentalhomes" target="_blank" class="{{ substr_count(url()->current(),'propert') > 0 ? ' activeNav': '' }}"><i class="fas fa-home"></i>Properties</a>
						</li>
{{--						<li>--}}
